...
@Component
public class LocationDepartmentMEFilterSelect implements IMemEntityFilterSelBuilder {
    private static final Class<?> TYPE = LocationDepartmentME.class;
    private final AbstractFilterSystemRepository<?, ?> filterSystemRepository;

    @Autowired
    public LocationDepartmentMEFilterSelect(FilterSystemLogRepository filterSystemLogRepository) {
