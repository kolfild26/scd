...
/**
 * Спуск прогноза и передача остальных данных из SCD для алгоритмов 1 и 2-го прогонов. Этап 2. Шаг 1.
 */
@Component
public class ForecastStage2Step1 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "FORECAST_STAGE2_STEP1";
    private static final String EXECUTOR_DESCRIPTION =
        "Отдача цепочек стратегий пополнения (Этап 2. Шаг 1.)";

    public ForecastStage2Step1() {
        super(
            EXECUTOR_NAME,
