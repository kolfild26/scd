...
/**
 * Подготовительные действия для алгоритма Спуска прогноза. Этап 1. Шаг 1.
 */
@Component
public class ForecastPrepStage1Step1 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "FORECAST_PREP_STAGE1_STEP1";
    private static final String EXECUTOR_DESCRIPTION =
        "Свёртка продаж МКС на уровне sku (Этап 1. Шаг 1.)";

    public ForecastPrepStage1Step1() {
        super(
            EXECUTOR_NAME,
