...
/**
 * Расчет 3D-Simple - плана продаж для ЦП (Спортмастер) (3D plan simple SCD). Этап 2. Шаг 2.
 */
@Component
public class Simple3dPlanStage2Step2 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "3D_PLAN_SIMPLE_STAGE2_STEP2";
    private static final String EXECUTOR_DESCRIPTION =
        "Усреднение исторических общих фактов продаж (Этап 2. Шаг 2.)";

    public Simple3dPlanStage2Step2() {
        super(
            EXECUTOR_NAME,
