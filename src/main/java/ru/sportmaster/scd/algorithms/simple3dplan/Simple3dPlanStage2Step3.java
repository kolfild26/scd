...
/**
 * Расчет 3D-Simple - плана продаж для ЦП (Спортмастер) (3D plan simple SCD). Этап 2. Шаг 3.
 */
@Component
public class Simple3dPlanStage2Step3 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "3D_PLAN_SIMPLE_STAGE2_STEP3";
    private static final String EXECUTOR_DESCRIPTION =
        "Применение текущего квотирования к коллекционному распределению (Этап 2. Шаг 3.)";

    public Simple3dPlanStage2Step3() {
        super(
            EXECUTOR_NAME,
