...
/**
 * Расчет 3D-Simple - плана продаж для ЦП (Спортмастер) (3D plan simple SCD). Этап 4. Шаг 7.
 */
@Component
public class Simple3dPlanStage4Step7 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "3D_PLAN_SIMPLE_STAGE4_STEP7";
    private static final String EXECUTOR_DESCRIPTION =
        "Консолидация результатов расчета 3D-плана по коллекции (Этап 4. Шаг 7.)";
    private static final Integer STAGE_NEXT_POINT = 1;
    private static final Integer STEP_NEXT_POINT = 1;

    public Simple3dPlanStage4Step7() {
        super(
            EXECUTOR_NAME,
