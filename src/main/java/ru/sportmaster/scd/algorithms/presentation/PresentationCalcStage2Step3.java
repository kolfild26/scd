...
/**
 * Расчет презентации на уровне ЦР. Этап 2. Шаг 3.
 */
@Component
public class PresentationCalcStage2Step3 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "PRESENTATION_CALC_STAGE2_STEP3";
    private static final String EXECUTOR_DESCRIPTION =
        "Приведение к равенству презентации на уровнях ЦР и ЦМ (Этап 2. Шаг 3.)";

    public PresentationCalcStage2Step3() {
        super(
            EXECUTOR_NAME,
