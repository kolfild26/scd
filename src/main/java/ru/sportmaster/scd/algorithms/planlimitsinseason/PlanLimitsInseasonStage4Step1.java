...
/**
 * InSeason: Плановые лимиты. Этап 4. Шаг 1.
 */
@Component
public class PlanLimitsInseasonStage4Step1 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "PLAN_LIMITS_INSEASON_STAGE4_STEP1";
    private static final String EXECUTOR_DESCRIPTION =
        "Округление значений плановых лимитов InSeason, приведение к общему объему фактических остатков"
            + " (Этап 4. Шаг 1.)";

    public PlanLimitsInseasonStage4Step1() {
        super(
            EXECUTOR_NAME,
