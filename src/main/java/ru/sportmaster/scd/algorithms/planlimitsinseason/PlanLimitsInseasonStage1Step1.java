...
/**
 * InSeason: Плановые лимиты. Этап 1. Шаг 1.
 */
@Component
public class PlanLimitsInseasonStage1Step1 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "PLAN_LIMITS_INSEASON_STAGE1_STEP1";
    private static final String EXECUTOR_DESCRIPTION =
        "Расчет величины прогноза спроса товара на уровне РЦР / магазин (Этап 1. Шаг 1.)";

    public PlanLimitsInseasonStage1Step1() {
        super(
            EXECUTOR_NAME,
