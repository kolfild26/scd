...
/**
 * InSeason: Стратегии пополнения. Этап 1. Шаг 1.
 */
@Component
public class ReplenishmentStrategyInseasonStage1Step1 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "REPL_STRATEGY_INSEASON_STAGE1_STEP1";
    private static final String EXECUTOR_DESCRIPTION =
        "Подготовка ассортиментной матрицы и плановых лимитов к дальнейшим расчетам";

    public ReplenishmentStrategyInseasonStage1Step1() {
        super(
            EXECUTOR_NAME,
