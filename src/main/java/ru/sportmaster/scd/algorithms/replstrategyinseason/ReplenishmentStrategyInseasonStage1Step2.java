...
/**
 * InSeason: Стратегии пополнения. Этап 1. Шаг 2.
 */
@Component
public class ReplenishmentStrategyInseasonStage1Step2 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "REPL_STRATEGY_INSEASON_STAGE1_STEP2";
    private static final String EXECUTOR_DESCRIPTION =
        "Подготовка спущенного прогноза спроса к дальнейшим расчетам";

    public ReplenishmentStrategyInseasonStage1Step2() {
        super(
            EXECUTOR_NAME,
