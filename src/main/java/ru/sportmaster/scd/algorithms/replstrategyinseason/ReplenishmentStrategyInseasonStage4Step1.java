...
/**
 * InSeason: Стратегии пополнения. Этап 4. Шаг 1.
 */
@Component
public class ReplenishmentStrategyInseasonStage4Step1 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "REPL_STRATEGY_INSEASON_STAGE4_STEP1";
    private static final String EXECUTOR_DESCRIPTION =
        "Назначение рекомендованных (автоматически определенных) стратегий пополнения InSeason";

    public ReplenishmentStrategyInseasonStage4Step1() {
        super(
            EXECUTOR_NAME,
