...
/**
 * Стратегии пополнения. Этап 2. Шаг 2.
 */
@Component
public class ReplenishmentStrategyStage2Step2 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "REPL_STRATEGY_STAGE2_STEP2";
    private static final String EXECUTOR_DESCRIPTION =
        "Ранжирование цветомодель-магазинов внутри цветомоделей на основе величины запаса (PL-UPA) (Этап 2. Шаг 2.)";

    public ReplenishmentStrategyStage2Step2() {
        super(
            EXECUTOR_NAME,
