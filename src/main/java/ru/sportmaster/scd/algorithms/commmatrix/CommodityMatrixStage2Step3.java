...
/**
 * Формирование товарной матрицы в SCD. Этап 2. Шаг 3.
 */
@Component
public class CommodityMatrixStage2Step3 extends AbstractAlgorithmJdbcCallStep {
    private static final String EXECUTOR_NAME = "COMMODITY_MATRIX_STAGE2_STEP3";
    private static final String EXECUTOR_DESCRIPTION =
        "Обработка исключений стоп-листа на уровне ЦР / магазин (Этап 2. Шаг 3.)";

    public CommodityMatrixStage2Step3() {
        super(
            EXECUTOR_NAME,
