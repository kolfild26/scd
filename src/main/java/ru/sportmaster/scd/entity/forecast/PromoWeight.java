...
@View
@Entity
@Table(name = "SCD_PROMO_DAY_WEIGHT_SETTINGS", schema = "SCD")
//Lombok
@Getter
@Setter
@NoArgsConstructor
...
public class PromoWeight {
    @Id
    @Column(name = "ID_PROMO_DAY_WEIGHT")
    private Long id;
    @ViewField
    @Column(name = "PROMO_DAY_WEIGHT_VALUE", precision = 2)
