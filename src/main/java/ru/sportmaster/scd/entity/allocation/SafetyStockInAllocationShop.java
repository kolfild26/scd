...
@View
@Entity
@Table(name = "ASCD_SS_ALLOCATION_SHOP", schema = "SCD_API")
//Lombok
@Getter
@Setter
@NoArgsConstructor
...
public class SafetyStockInAllocationShop implements IEntity<Long> {
    @Id
    @GenericGenerator(
        name = "allocationShopSequence",
        type = ExistingOrSequenceIdGenerator.class,
        parameters = {
            @org.hibernate.annotations.Parameter(name = "sequence_name", value = "SEQ_ASCD_SS_ALLOCATION_SHOP"),
            @org.hibernate.annotations.Parameter(name = "initial_value", value = "1"),
            @org.hibernate.annotations.Parameter(name = "increment_size", value = "1"),
            @org.hibernate.annotations.Parameter(name = "optimizer", value = "pooled-lo")
        }
    )
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "allocationShopSequence")
    @Column(name = "ID_ALLOCATION_SHOP")
    private Long id;
    @ViewField
