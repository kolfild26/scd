...
@View
@Entity
@Table(name = "SCD_MDM_SALES_REGION", schema = "SCD")
//Lombok
@Getter
@Setter
@NoArgsConstructor
...
public class CountryGroup implements IEntity<Long> {
    @Id
    @Column(name = "ID_SALES_REGION", precision = 38, nullable = false, updatable = false)
    private Long id;
    @ViewField(order = 6)
    @Column(name = "NAME")
    private String name;
