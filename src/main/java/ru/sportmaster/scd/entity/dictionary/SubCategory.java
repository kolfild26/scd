...
@Entity
@Table(name = "SCD_SUBCATEGORY_LOOKUP", schema = "SCD")
//Lombok
@Getter
@Setter
@NoArgsConstructor
...
public class SubCategory implements IEntity<Long> {
    @Id
    @Column(name = "ID_SUBCATEGORY", precision = 38, nullable = false, updatable = false)
    private Long id;
