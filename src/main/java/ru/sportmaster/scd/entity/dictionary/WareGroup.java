...
@Entity
@Table(name = "SCD_GRP_OF_WARE_LOOKUP", schema = "SCD")
//Lombok
@Getter
@Setter
@NoArgsConstructor
...
public class WareGroup implements IEntity<Long> {
    @Id
    @Column(name = "ID_GRP_OF_WARE", precision = 38, nullable = false, updatable = false)
    private Long id;
