...
@Entity
@Table(name = "SCD_CLUS_CATEGORY_HIERARCHY", schema = "SCD")
//Lombok
@Getter
@Setter
@NoArgsConstructor
...
public class CategoryHierarchy implements IEntity<Long> {
    @Id
    @Column(name = "ID_CATEGORY_HIERARCHY", precision = 38, nullable = false, updatable = false)
    private Long id;
