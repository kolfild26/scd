...
@Entity
@Table(name = "SCD_DC_V_COLL_MSC_COUNTRY_DTMA_STL", schema = "SCD")
@SuperBuilder
@Getter
@Setter
@NoArgsConstructor
...
public class StopListBusinessCountryMSC extends ListBusinessCountryMSC implements IEntity<Long> {
    @Id
    @Column(name = "ID_COLL_MSC_COUNTRY_DTMA_STL")
    private Long id;
