...
@Entity
@Table(name = "SCD_DC_V_COLL_MSC_SHOP_CATEGORY_PT_OSPERTYP_VAL", schema = "SCD")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
...
public class LcMinUpaMSC implements IEntity<Long> {
    @Id
    @Column(name = "ID_COLL_MSC_SHOP_CATEGORY_PT_OSPERTYP_VAL")
    private Long id;
    @ManyToOne
