...
@Entity
@Table(name = "SCD_DC_V_COLL_DSC_SHOP_PT_EXTS_PLAN_LIMIT", schema = "SCD")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
...
public class PlanLimitDSC implements IEntity<Long> {
    @Id
    @Column(name = "ID_COLL_DSC_SHOP_PT_EXTS_PLAN_LIMIT")
    private Long id;
    @ManyToOne
