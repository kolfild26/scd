...
@Entity
@Table(name = "SCD_DC_V_COLL_DSC_SHOP_PT_EXTS_CATEGORY_MIN_UPA", schema = "SCD")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
...
public class MinUpaDSC implements IEntity<Long> {
    @Id
    @Column(name = "ID_COLL_DSC_SHOP_PT_EXTS_CATEGORY_MIN_UPA")
    private Long id;
    @ManyToOne
