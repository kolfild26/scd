...
@View
@Entity
@Table(name = "SCD_MDM_DEV_STYLE", schema = "SCD")
//Lombok
@Getter
@Setter
@NoArgsConstructor
...
public class DevModel implements IEntity<Long> {
    @Id
    @ViewField
    @Column(name = "ID_DEV_STYLE", precision = 38, nullable = false, updatable = false)
    private Long id;
    @ViewField
