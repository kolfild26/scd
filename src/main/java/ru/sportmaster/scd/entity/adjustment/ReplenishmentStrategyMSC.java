...
@Entity
@Table(name = "SCD_DC_V_COLL_PRD_MSC_SHOP_REPL_STR", schema = "SCD")
@SuperBuilder
@Getter
@Setter
@NoArgsConstructor
...
public class ReplenishmentStrategyMSC extends ReplenishmentStrategySC implements IEntity<Long> {
    @Id
