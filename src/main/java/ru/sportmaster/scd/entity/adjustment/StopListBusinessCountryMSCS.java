...
@Entity
@Table(name = "SCD_DC_V_COLL_MSCS_COUNTRY_DTMA_STL", schema = "SCD")
@SuperBuilder
@Getter
@Setter
@NoArgsConstructor
...
public class StopListBusinessCountryMSCS extends ListBusinessCountryMSCS implements IEntity<Long> {
    @Id
    @Column(name = "ID_COLL_MSCS_COUNTRY_DTMA_STL")
    private Long id;
