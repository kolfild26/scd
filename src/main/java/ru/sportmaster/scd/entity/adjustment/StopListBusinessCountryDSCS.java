...
@Entity
@Table(name = "SCD_DC_V_COLL_DSCS_COUNTRY_DTMA_STL", schema = "SCD")
@SuperBuilder
@Getter
@Setter
@NoArgsConstructor
...
public class StopListBusinessCountryDSCS extends ListBusinessCountryDSCS implements IEntity<Long> {
    @Id
