...
@NoArgsConstructor
@AllArgsConstructor
@StructType("SCD.SCD_DC_TP_COLL_DSCS_SHOP_CATEGORY_PT_OSPERTYP_VAL")
public class TpLcMinUpaDSCS implements ITpAdjustmentRow {
    @Column(name = "id_coll_dscs_shop_category_pt_ospertyp_val")
    private Long id;
