...
@Entity
@Table(name = "SCD_DC_V_COLL_MSCS_SHOP_REPL_END_DAT", schema = "SCD")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
...
public class ReplEndDateMSCS implements IEntity<Long> {
    @Id
    ...
    @ViewField(
        required = false,
        rules = @ViewFieldRule(calendarType = CalendarEditorType.WEEK)
    )
