...
@Entity
@Table(name = "SCD_DC_V_COLL_MSCS_SHOP_CATEGORY_PT_OSPERTYP_VAL", schema = "SCD")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
...
public class LcMinUpaMSCS implements IEntity<Long> {
    @Id
    @Column(name = "ID_COLL_MSCS_SHOP_CATEGORY_PT_OSPERTYP_VAL")
    private Long id;
    @ManyToOne
    ...
    @ManyToOne
    @JoinColumn(name = "ID_MERCH_COLOR_SIZE")
    @View(flat = true)
    @ViewField
    private MerchColorSize size;
    @ManyToOne
