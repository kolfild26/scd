...
@NoArgsConstructor
@AllArgsConstructor
@StructType("SCD.SCD_DC_TP_COLL_MSC_SHOP_MIN_UPA_INEX_DAT_STRTL")
public class TpStartListStoreMSC implements ITpAdjustmentRow {
    @Column(name = "id_coll_msc_shop_min_upa_inex_dat_strtl")
    private Long id;
